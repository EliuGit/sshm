...
var english = map[string]string{
	...
	"home.help_palette":                  "Open command palette",
	...
	"home.detail_host_port":              "Host/Port",
	...
	"palette.home_title":                 "Home actions",
	"palette.browser_title":              "File workspace actions",
	"palette.placeholder":                "Type action or shortcut",
	"palette.prompt":                     "Action: ",
	"palette.empty":                      "No matching actions",
	"palette.home.search":                "Search connections",
	"palette.home.create":                "Create connection",
	"palette.home.groups":                "Filter by group",
	"palette.home.import":                "Import ssh_config",
	"palette.home.clear":                 "Clear active filter",
	"palette.home.shell":                 "Open selected shell",
	"palette.home.browser":               "Open selected file workspace",
	"palette.home.edit":                  "Edit selected connection",
	"palette.home.delete":                "Delete selected connection",
	"palette.home.move_group":            "Move selected connection to group",
	"palette.browser.open":               "Open selected item",
	"palette.browser.up":                 "Go to parent directory",
	...
	"palette.browser.clear":              "Clear active filter",
	"palette.browser.upload":             "Upload selected item",
	"palette.browser.download":           "Download selected item",
...
var chinese = map[string]string{
	...
	"shortcut.choose":                    "选择",
	"palette.title":                      "命令面板",
	"palette.home_title":                 "主页动作",
	"palette.browser_title":              "文件工作区动作",
	"palette.placeholder":                "输入动作或快捷键",
	"palette.prompt":                     "动作：",
	"palette.empty":                      "没有匹配的动作",
	"palette.home.search":                "搜索连接",
	"palette.home.create":                "创建连接",
	"palette.home.groups":                "按分组过滤",
	"palette.home.import":                "导入 ssh_config",
	"palette.home.clear":                 "清空当前过滤",
	"palette.home.shell":                 "打开选中 Shell",
	"palette.home.browser":               "打开选中文件工作区",
	"palette.home.edit":                  "编辑选中连接",
	"palette.home.delete":                "删除选中连接",
	"palette.home.move_group":            "移动选中连接到分组",
	"palette.browser.open":               "打开选中项",
	"palette.browser.up":                 "进入上级目录",
	...
	"palette.browser.clear":              "清空当前过滤",
	"palette.browser.upload":             "上传选中项",
	"palette.browser.download":           "下载选中项",
